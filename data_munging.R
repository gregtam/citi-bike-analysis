...
# Write first 10 rows to CSV
write.csv(take(july_citi_sdf, 10),
          'csv_files/july_citi_sdf_10.csv',
          row.names = F)
...
start_station_sdf <- july_citi_date_sdf %>%
...
end_station_sdf <- july_citi_date_sdf %>%
